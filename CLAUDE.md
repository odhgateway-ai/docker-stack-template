# Claude Code Project Rules (dockerstack-s3proxy)
...
Claude Code should treat task as incomplete until `.opushforce.message` is updated to reflect the latest work.
